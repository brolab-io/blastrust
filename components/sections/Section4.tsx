...
const Section4 = () => {
  return (
    <div className="container mx-auto py-12">
      <h2 className="text-4xl font-bold text-center tracking-tight text-gray-500 sm:text-6xl">
      ...
      <div className="grid sm:grid-cols-2 xl:grid-cols-4 py-12 gap-10 px-10">
        {SECTION_DATA.map((item, index) => (
          <div
            key={item.id}
            className="text-center space-y-3 px-10 py-12 box-border shadow-lg rounded-xl border-2 border-gray-500 shadow-black group"
          >
